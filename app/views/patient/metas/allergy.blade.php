...
<section class="panel panel-default">
  <header class="panel-heading font-bold"> Formulario de registro de Alergias </header>
  <div class="panel-body">
    <form class="form-horizontal" id="createmetas" method="post" >
      <div class="form-group">
        <label class="col-sm-2 control-label" for="input-id-1">Describa la Alergia</label>
        <div class="col-sm-10">
          <input id="allergy" name="allergy" type="text" class="form-control" placeholder="Especifique la Alergia del personal si posee">
        </div>
      </div>
      ...
      <div class="form-group">
        <div class="col-sm-4 col-sm-offset-2">
          ...
          <input type="submit" class="btn btn-primary" value="Añadir Alergia" />
        </div>
      </div>
    </form>
  </div>
